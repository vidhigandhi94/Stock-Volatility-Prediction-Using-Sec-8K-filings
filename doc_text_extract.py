...
quandl_key = "J3xuWYUez67KVGhhkQCs"
av_key = "QGR3QMFI8YGSKC7A"
...
for df in tqdm(np.array_split(crawled_df,chunks)):
    ...
    df[['price_change','vix']] = df[['ticker','release_date']].apply(fin_data.get_change,axis=1,result_type='broadcast')
